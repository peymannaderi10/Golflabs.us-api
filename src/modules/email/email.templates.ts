...
import { EmailTemplate, BookingEmailData, TeamInviteEmailData, TeamStatusEmailData, AttendanceReminderEmailData } from './email.types';
...
export class EmailTemplates {
  ...
  static attendanceReminder(data: AttendanceReminderEmailData): EmailTemplate {
    return {
