...
const unlockRoutes = (socketService) => {
    ...
    router.post('/employee-unlock', (0, express_validator_1.body)('locationId').isUUID().withMessage('locationId must be a valid UUID'), validation_1.handleValidationErrors, auth_1.authenticateEmployee, unlockController.employeeUnlock);
    return router;
};
