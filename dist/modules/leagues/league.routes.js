...
const createLeagueRoutes = (socketService) => {
    ...
    router.post('/', auth_1.authenticateEmployee, controller.createLeague);
    ...
    router.put('/:leagueId', auth_1.authenticateEmployee, controller.updateLeague);
    router.post('/:leagueId/activate', auth_1.authenticateEmployee, controller.activateLeague);
    // --- Course management ---
    ...
    router.post('/:leagueId/enroll-and-pay', auth_1.authenticateUser, controller.enrollAndPay);
    // --- Prize pool ledger ---
    ...
    router.post('/:leagueId/teams', auth_1.authenticateUser, controller.createTeam);
