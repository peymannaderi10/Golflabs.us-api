...
class UserService {
     ...
     */
    associateUserWithLocation(userId, locationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data: location, error: locErr } = yield database_1.supabase
                .from('locations')
                .select('id')
                .eq('id', locationId)
                .maybeSingle();
            ...
            if (error) {
                logger_1.logger.error({ err: error, userId, locationId }, 'Failed to associate user with location');
