...
class EmailTemplates {
    ...
    // =====================================================
    static membershipWelcome(data) {
        const benefitsHtml = [];
        if (data.freeHoursPerMonth)
            benefitsHtml.push(`<li style="padding: 6px 0;">${data.freeHoursPerMonth} free hours per month</li>`);
        if (data.bookingWindowDays)
            benefitsHtml.push(`<li style="padding: 6px 0;">Book up to ${data.bookingWindowDays} days in advance</li>`);
        if (data.guestPassesPerMonth)
            benefitsHtml.push(`<li style="padding: 6px 0;">${data.guestPassesPerMonth} guest passes per month</li>`);
        return {
    ...
    static membershipCanceled(data) {
