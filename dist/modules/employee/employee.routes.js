 ...
 */
router.put('/pricing-rules/:ruleId', auth_1.authenticateEmployee, (req, res) => pricingController.updatePricingRule(req, res));
/**
 * DELETE /employee/pricing-rules/:ruleId
 * Delete a pricing rule (requires employee authentication)
 */
router.delete('/pricing-rules/:ruleId', auth_1.authenticateEmployee, (req, res) => pricingController.deletePricingRule(req, res));
/**
