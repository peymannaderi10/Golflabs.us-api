...
const createBayRoutes = (socketService) => {
    ...
    bayRoutes.put('/league-mode/activate', auth_1.authenticateEmployee, controller.activateLeagueMode);
    bayRoutes.put('/league-mode/deactivate', auth_1.authenticateEmployee, controller.deactivateLeagueMode);
