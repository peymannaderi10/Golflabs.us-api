...
exports.paymentRoutes.post('/bookings/:bookingId/create-payment-intent', auth_1.authenticateUser, paymentRateLimit, (0, express_validator_1.param)('bookingId').isUUID().withMessage('Booking ID must be a valid UUID'), validation_1.handleValidationErrors, controller.createPaymentIntent);
exports.paymentRoutes.post('/update-payment-intent', auth_1.authenticateUser, paymentRateLimit, (0, express_validator_1.body)('paymentIntentId').matches(/^pi_[a-zA-Z0-9_]+$/).withMessage('Invalid payment intent ID format'), (0, express_validator_1.body)('email').optional().isEmail().withMessage('Invalid email format'), (0, express_validator_1.body)('firstName').optional().isLength({ min: 1, max: 50 }).withMessage('First name must be 1-50 characters'), (0, express_validator_1.body)('lastName').optional().isLength({ min: 1, max: 50 }).withMessage('Last name must be 1-50 characters'), (0, express_validator_1.body)('phone').optional().matches(/^[\d\s\-\+\(\)]+$/).withMessage('Invalid phone format'), validation_1.handleValidationErrors, controller.updatePaymentIntent);
