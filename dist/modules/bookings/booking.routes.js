...
const createBookingRoutes = (socketService) => {
    ...
    bookingRoutes.get('/employee', auth_1.authenticateEmployee, (0, auth_1.validateLocationAccess)('query'), controller.getEmployeeBookings);
    bookingRoutes.get('/employee/customers/search', auth_1.authenticateEmployee, controller.searchCustomers);
    bookingRoutes.post('/employee/create', auth_1.authenticateEmployee, (0, auth_1.validateLocationAccess)('body'), (0, validation_1.validateUUID)('locationId', 'body'), (0, validation_1.validateUUID)('spaceId', 'body'), (0, express_validator_1.body)('startTime').notEmpty().withMessage('startTime is required'), (0, express_validator_1.body)('endTime').notEmpty().withMessage('endTime is required'), (0, express_validator_1.body)('date').notEmpty().withMessage('date is required'), validation_1.handleValidationErrors, controller.employeeCreateBooking);
