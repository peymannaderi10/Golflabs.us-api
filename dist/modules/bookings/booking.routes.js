...
const createBookingRoutes = (socketService) => {
    ...
    bookingRoutes.post('/employee/create', auth_1.authenticateEmployee, (0, auth_1.validateLocationAccess)('body'), (0, validation_1.validateUUID)('locationId', 'body'), (0, validation_1.validateUUID)('bayId', 'body'), (0, express_validator_1.body)('startTime').notEmpty().withMessage('startTime is required'), (0, express_validator_1.body)('endTime').notEmpty().withMessage('endTime is required'), (0, express_validator_1.body)('date').notEmpty().withMessage('date is required'), validation_1.handleValidationErrors, controller.employeeCreateBooking);
