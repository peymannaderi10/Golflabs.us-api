        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (updates.customDomain !== undefined) {
                if (updates.customDomain) {
                    const { LocationService } = yield Promise.resolve().then(() => __importStar(require('../locations/location.service')));
                    const locationService = new LocationService();
                    const availability = yield locationService.isSubdomainAvailable(updates.customDomain, locationId);
